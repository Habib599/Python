...
bank = Bank("Dutch Bangla Bank Ltd", "Dhaka")
admin = bank.createAcoount("admin", "admin@gmail.com", "dhaka", "admin")
user = bank.createAcoount("Habib", "mdhabiburr599@gmail.com", "dhaka","user")
